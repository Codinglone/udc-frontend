        ...
        <div className="mx-auto max-w-screen-xl lg:py-2 lg:px-16">
          ...
          <div className="grid gap-6 mb-6 lg:mb-16 md:grid-cols-2">
            ...
            <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
              ...
              >
                <img
                  className="w-full rounded-lg sm:rounded-none sm:rounded-l-lg w-full h-full"
              ...
              <div className="p-5">
                <h3 className="text-xl font-bold tracking-tight text-blue-700 dark:text-white">
                  <a href="#">Alain Remy MUTUZO</a>
                </h3>
                <span className="text-gray-500 dark:text-gray-400">
                 CEO
                </span>
                <p className="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">
                  Remy is the CEO at UDC.
                </p>
                  ...
                  <li>
                    ...
                    >
                      ...
                      >
                        <path
                          fillRule="evenodd"
                          d="M12 2a10 10 0 1 0 0 20 10 10 0 0 0 0-20zm1.986 7.67h2.956V7.657h-2.956v2.014zm3.252 0h2.898V7.657h-2.898v2.014zm-6.146 0h2.955V7.657h-2.955v2.014zm3.147 6.292v-2.018h2.957v2.018H14.29zm3.24 0v-2.018h2.897v2.018h-2.897zm-6.136 0v-2.018h2.956v2.018h-2.956zm-3.294 2.6a8.07 8.07 0 0 1-3.838-1.071l1.543-1.542a5.537 5.537 0 0 0 2.488.586 5.556 5.556 0 0 0 3.929-1.632l1.428 1.428a8.087 8.087 0 0 1-6.55 2.231zm9.36-2.762l1.542 1.541c-1.133 1.554-3.076 2.604-5.34 2.604a8.09 8.09 0 0 1-3.162-.645l1.428-1.427c.616.26 1.285.4 1.976.4 .744 0 1.458-.175 2.105-.49l1.451 1.45zm-6.378-5.578l-1.541-1.542A8.034 8.034 0 0 1 12 6.346a8.077 8.077 0 0 1 4.524 1.388L15.96 9.275a5.55 5.55 0 0 0-2.453-.573 5.537 5.537 0 0 0-4.95 3.034L6.346 12l.001-.004a8.068 8.068 0 0 1-1.071 3.838l1.542 1.542a5.56 5.56 0 0 0 2.603-5.34z"
                          clipRule="evenodd"
                        />
                      </svg>
                    </a>
            ...
            <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
              ...
              >
                <img
                  className="w-full rounded-lg sm:rounded-none sm:rounded-l-lg w-full h-full"
                  src="https://images.unsplash.com/photo-1600878459108-617a253537e9?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=687&q=80"
                  alt="Michael Avatar"
                />
              </a>
              <div className="p-5">
                <h3 className="text-xl font-bold tracking-tight text-blue-700 dark:text-white">
                  <a href="#">Samuel NGABO</a>
                </h3>
                <span className="text-gray-500 dark:text-gray-400">
            ...
            <div className="items-center bg-gray-50 rounded-lg shadow sm:flex dark:bg-gray-800 dark:border-gray-700">
              ...
              <div className="p-5">
                ...
                <p className="mt-3 mb-4 font-light text-gray-500 dark:text-gray-400">
                Christian is the managing director at UDC.
                </p>
                <ul className="flex space-x-4 sm:mt-0">
                  <li>
                    <a
