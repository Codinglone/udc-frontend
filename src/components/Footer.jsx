...
<footer className=" dark:bg-gray-900 border-t border-gray-300">
    <div className="p-4 py-6 w-full">
        <div className="md:flex md:justify-between md:w-full bg-blue-800 h-8 md:h-full">
          <div className="mt-5 md:mb-0">
              <a href="/" className="flex items-center">
                  <img src={Logo} className="h-20 mr-4" alt="FlowBite Logo" />
                  <span className="self-center text-2xl mt-5 font-semibold whitespace-nowrap text-white dark:text-white">UDC LTD</span>
              </a>
              <ul className="text-white dark:text-gray-400 font-medium m-1">
                      <li className="mb-7">
                          <a href="/" className="hover:underline">Phone: +250784427142</a>
                      </li>
                      <li classNameName='mb-6'>
                          <a href="/" className="hover:underline">E-mail: codinglone@gmail.com</a>
                      </li>
                      <li className="mb-6">
                          <a href="/" className="hover:underline">Whatsapp: +250784427142</a>
                      </li>
                      <li classNameName='mb-6'>
                          <a href="/" className="hover:underline">Telegram: +250784427142</a>
                      </li>
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
              <div>
                  <h2 className="mt-16 mx-20 text-md font-extrabold text-white uppercase dark:text-white">Follow us</h2>
                  <ul className="text-white dark:text-gray-400 font-medium">
                      <li className="mt-8 mx-20">
                          <a href="https://twitter.com/" target='_blank' className="hover:underline ">Twitter</a>
                      </li>
                      <li className="mt-6 mx-20">
              ...
              <div>
                  <h2 className="mt-16 mx- text-md font-extrabold text-white uppercase dark:text-white">Useful Links</h2>
                  <ul className="text-white dark:text-gray-400 font-medium">
                      <li className="mt-8">
                          <a href="#" className="hover:underline">Home</a>
                      </li>
                      <li classNameName='mt-7'>
              ...
              <div>
                  <h2 className="mt-16 my-6 text-md font-extrabold text-white uppercase dark:text-white">Services we provide</h2>
                  <ul className="text-white dark:text-gray-400 font-medium">
                      <li className="mt-7 my-6">
                          <a href="/" className="hover:underline">Architetural & Interior Design</a>
                      </li>
                      <li classNameName='mt-4 my-6'>
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2023 <a href="/" className="hover:underline">UDC™</a>. All Rights Reserved.
          </span>
