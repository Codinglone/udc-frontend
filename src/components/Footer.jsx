...
<footer className="dark:bg-gray-900 border-t border-gray-200">
    <div className="p-32 py-8">
        <div className="flex justify-center items-center gap-16">
          <div className="mb-8 ml-24">
              <a href="/" className="flex items-center">
                  <img src={Logo} className="h-20 mb-2" alt="FlowBite Logo" />
                  <span className="self-center text-2xl mt-3 font-extrabold whitespace-nowrap text-gray-800 dark:text-white">UDC LTD</span>
              </a>
              <ul className="grid gap-8 text-gray-800 dark:text-gray-400 text-lg font-bold">
                      <li className="">
                      ...
                      <li classNameName=''>
                          <a href="/" className="hover:underline">Location: KIGALI - KICUKIRO</a>
                      </li>
                    
                  </ul>
          </div>
          <div className='ml-20'>
                  <h2 className="mb-6 text-lg font-extrabold text-gray-800 uppercase dark:text-white">Useful Links</h2>
                  <ul className="grid gap-8 text-gray-800 dark:text-gray-400 text-lg font-bold">
                      <li className="">
              ...
              <div className='ml-20'>
                  <h2 className="mb-6 text-lg font-extrabold text-gray-800 uppercase dark:text-white">Services</h2>
                  <ul className="grid gap-8 text-gray-800 dark:text-gray-400 text-lg font-bold">
                      <li className="">
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
          ...
          <div className="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
              ...
              <a href="universaldesignandcons@gmail.com" className="text-gray-500 hover:text-gray-900 dark:hover:text-white">
